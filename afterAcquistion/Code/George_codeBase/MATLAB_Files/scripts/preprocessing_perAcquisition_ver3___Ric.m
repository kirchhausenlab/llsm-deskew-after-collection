...
dirSource = '/llsm/AO-LLSM/Ricardo/2021/01_January/01222021';
scratch_dirSink = '/net/tkfastfs/scratch/Ricardo';
datasync_dirSink = '/tkstorage/data1expansion/datasync3/Ricardo';
...
dirSink_ds3_processed = [dirSink_ds3 filesep 'preprocessed'];
...
% fix backgorund for ric
%
clc
% get chromatic offset
C = getChroma(dirSink, false, false);


%%  Select which Ex to transfer, DS, CO --- CHOOSE keyword after all are transferred
str = cell(1,9)
for kk =2:10
    str{kk-1} = sprintf('Ex%02d_',kk);
end
keywords = str
%%
% keywords = {'Ex02_','Ex03_'};
...
dirSink = '/net/tkfastfs/scratch/Alex/20210108_p5_p55_sCMOS_Alex/ToTrack_Giusseppe';
dirSource = dirSink;
I = getIllum(dirSink);
I.chan
%
