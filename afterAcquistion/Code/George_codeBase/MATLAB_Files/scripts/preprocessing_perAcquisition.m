...
dirSource = '/llsm/tklab-llsm/20210108_p5_p55_sCMOS_Alex';
dirSink_old = '/net/tkfastfs/scratch/George';

% transfer dirSource to dirSink
dirSink = transferCalibrationFiles(dirSource, dirSink_old);
...
%%
keywords = {'Ex01pilot-'}
for oo = 1:length(keywords)
    keyword = char(keywords{oo})
% keyword = 'Ex31_';
