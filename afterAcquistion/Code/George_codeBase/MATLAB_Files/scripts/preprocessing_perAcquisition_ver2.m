...
dirSource = '/llsm/tklab-llsm/20210105_p5_p55_sCMOS_Gu';
scratch_dirSink = '/net/tkfastfs/scratch/George';
datasync_dirSink = '/tkstorage/data1expansion/datasync3';

% transfer dirSource to dirSink
dirSink = transferCalibrationFiles(dirSource, scratch_dirSink);
dirSink_ds3 = transferCalibrationFiles(dirSource, datasync_dirSink);
dirSink_ds3_raw = [dirSink_ds3 filesep 'raw'];
dirSink_ds3_preprocessed = [dirSink_ds3 filesep 'preprocessed'];
% copy calibration folders to raw and preprocessed
copyfile([dirSink_ds3 filesep 'LLSCalibration'], [dirSink_ds3_raw filesep 'LLSCalibration'])
movefile([dirSink_ds3 filesep 'LLSCalibration'], [dirSink_ds3_preprocessed filesep 'LLSCalibration'])
...
keyword = 'Ex01_';
Exs =  findKeywordDFS(dirSink, keyword);
