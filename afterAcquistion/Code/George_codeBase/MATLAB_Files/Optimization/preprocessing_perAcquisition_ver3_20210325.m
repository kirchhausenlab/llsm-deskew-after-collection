...
dirSource = '/llsm/AO-LLSM/Ricardo/2021/03312021';
scratch_dirSink = '/nfs/scratch/Ricardo';
datasync_dirSink = '/nfs/data1expansion/datasync3/Ricardo/2021/03_March';
...
keywords = {};
for ii = 1:2
    keywords{counter} = sprintf('Ex%02d_',ii-1);
    counter = counter + 1;
end
...
%% If in scratch run below


%% If data is not in llsm D drive. Just preprocess, no copy


dirSink = '/scratch/Ricardo/2021/01_January/01262021/NAMax0p4_NAMin_0p3';
dirSource = dirSink;
I = getIllum(dirSink);
I.chan
%
